...
void putNotPixel(uint8_t x, uint8_t y); // Isac
...
void displayNotLine(int x, int y, int len); // Isac
...
void displayScore(int score); // Isac

// converts an int to a string
void numToString(int score, char* str); // Isac
